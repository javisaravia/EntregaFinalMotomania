-- COPIA Y PEGA ESTO EN TU GESTOR DE BASE DE DATOS (phpMyAdmin / MySQL Workbench)

-- 1. Añadir las columnas que faltan a la tabla 'routes'
ALTER TABLE routes 
...
-- 3. Crear tabla de valoraciones (si no existe)
